...
export CONTAINER_NAME=ci_native_nowallet_libItecoinkernel
...
export GOAL="install"
export Itecoin_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
