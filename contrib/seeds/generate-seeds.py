...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef Itecoin_CHAINPARAMSSEEDS_H\n')
    g.write('#define Itecoin_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the Itecoin network\n')
    ...
    g.write('#endif // Itecoin_CHAINPARAMSSEEDS_H\n')
