...
# Extract options
function __fish_Itecoin_tx_get_options
...
# Extract commands
function __fish_Itecoin_tx_get_commands
...
complete \
    --command Itecoin-tx \
    --condition "not __fish_Itecoin_seen_cmd (__fish_Itecoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_Itecoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command Itecoin-tx \
    --arguments "(__fish_Itecoin_tx_get_commands)" \
    --no-files
