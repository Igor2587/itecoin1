...
complete --command Itecoind --no-files

# Extract options
function __fish_Itecoind_get_options
...
complete \
    --command Itecoind \
    --arguments "(__fish_Itecoind_get_options --nofiles)"
