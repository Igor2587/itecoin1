...
complete --command Itecoin-qt --no-files

# Extract options
function __fish_Itecoinqt_get_options
...
complete \
    --command Itecoin-qt \
    --arguments "(__fish_Itecoinqt_get_options --nofiles)"
