...
(define* (make-Itecoin-cross-toolchain target
                                       #:key
...
desirable for building Itecoin Core release binaries."
...
;; failure; see https://github.com/Itecoin/Itecoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-Itecoin-cross-toolchain target)))
