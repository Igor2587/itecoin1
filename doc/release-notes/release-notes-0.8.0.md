Itecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Itecoin/files/Itecoin/Itecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Itecoin
...
New/changed settings (command-line or Itecoin.conf file)
--------------------------------------------------------
