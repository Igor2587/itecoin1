...
Itecoin Core version 0.19.1 is now available from:

  <https://Itecoincore.org/bin/Itecoin-core-0.19.1/>
...
From Itecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Itecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Itecoin Core does not yet change appearance when
...
- #17488 fix "Itecoind already running" warnings on macOS (fanquake)
