Itecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Itecoin/files/Itecoin/Itecoin-0.5.4/
...
http://gitorious.org/Itecoin/Itecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Itecoin-Qt notifications under Growl 1.3.
Increase required age of Itecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxItecoin properly when installing Itecoin-Qt over it. (Windows)
