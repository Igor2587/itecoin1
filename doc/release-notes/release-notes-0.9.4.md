Itecoin Core version 0.9.4 is now available from:

  https://Itecoin.org/bin/0.9.4/
...
this update is incompatible with the Itecoin system and could lead to consensus
forks.

Itecoin Core released binaries from https://Itecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~Itecoin/+archive/ubuntu/Itecoin
- A third-party or self-compiled Itecoin Core

upgrade to Itecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
