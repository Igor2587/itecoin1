Itecoin Core version 0.16.1 is now available from:

  <https://Itecoincore.org/bin/Itecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting Itecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure Itecoind processes are cleaned up when tests end (sdaftuar)
