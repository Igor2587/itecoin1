Itecoin Core version 0.10.4 is now available from:

  <https://Itecoin.org/bin/Itecoin-core-0.10.4/>
...
- #6953 `43c2789` Split Itecoin-tx into its own package
- #6953 `dfe0d4d` Include Itecoin-tx binary on Debian/Ubuntu
