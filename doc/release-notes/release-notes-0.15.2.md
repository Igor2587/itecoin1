Itecoin Core version *0.15.2* is now available from:

  <https://Itecoincore.org/bin/Itecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in Itecoin-tx (TheBlueMatt)
