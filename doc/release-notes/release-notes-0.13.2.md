Itecoin Core version 0.13.2 is now available from:

  <https://Itecoin.org/bin/Itecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update Itecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Itecoin-tx to create v2 transactions (itcdrak)
