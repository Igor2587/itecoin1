...
class SegWitTest(ItecoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older Itecoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let Itecoind fill it in.
