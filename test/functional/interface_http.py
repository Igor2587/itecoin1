#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Itecoin Core developers
...
class HTTPBasicsTest (ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        out1 = conn.getresponse().read()
        assert b'"error":null' in out1
        assert conn.sock is not None  #connection must be closed because Itecoind should use keep-alive by default
