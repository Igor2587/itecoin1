...
class TransactionTimeRescanTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        # generate some itc to create transactions and check blockcount
        ...
        # send 10 itc to user's first watch-only address
        self.log.info('Send 10 itc to user')
        ...
        # send 5 itc to our second watch-only address
        self.log.info('Send 5 itc to user')
        ...
        # send 1 itc to our third watch-only address
        self.log.info('Send 1 itc to user')
