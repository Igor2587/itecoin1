...
class BumpFeeTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 itc (100,000 Igors)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Itecoin to serialize ECDSA signatures means that signatures can have a
