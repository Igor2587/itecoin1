...
class TestItecoinCli(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `Itecoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and Itecoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and Itecoin-cli getwalletinfo return expected wallet info")
            ...
            # Test Itecoin-cli -generate with -rpcwallet in multiwallet mode.
