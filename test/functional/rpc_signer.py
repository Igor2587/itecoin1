...
Verify that a Itecoind node can use an external signer command.
...
class RPCSignerTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart Itecoind with -signer=<cmd>',
