#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Itecoin Core developers
...
class TxDownloadTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new Itecoind instances, as setting mocktimes has long-term effects on when
