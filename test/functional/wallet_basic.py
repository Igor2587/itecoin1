...
class WalletTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Itecoin address
            assert_raises_rpc_error(-5, "Invalid Itecoin address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Itecoin address
            assert_raises_rpc_error(-5, "Invalid Itecoin address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Itecoin address or script", self.nodes[0].importaddress, "invalid")
