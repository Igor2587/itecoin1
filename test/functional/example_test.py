...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ItecoinTestFramework
    pass


class ExampleTest(ItecoinTestFramework):
    # Each functional test is a subclass of the ItecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ItecoinTestFramework class so other tests can use it."""
