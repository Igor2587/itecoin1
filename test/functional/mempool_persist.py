...
By default, Itecoind will dump mempool on shutdown and
...
class MempoolPersistTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent Itecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
