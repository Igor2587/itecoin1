...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/Itecoin/Itecoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(ItecoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/Itecoin/Itecoin/issues/27380
