...
This file is modified from python-Itecoinlib.
"""
...
def bn2vch(v):
    """Convert number to Itecoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Igor codebase"""
    r = b''
