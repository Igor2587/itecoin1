...
class TestShell:
    """Wrapper Class for ItecoinTestFramework.

    The TestShell class extends the ItecoinTestFramework
    ...
    class __TestShell(ItecoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ItecoinTestFramework child class.
            self.num_nodes = 1
