...
"""
Test starting Itecoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ItecoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that Itecoind has bound on "::1" (for RPC) and "::" (for P2P).
