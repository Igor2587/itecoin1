...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/Itecoin/Itecoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/Itecoin/Itecoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
