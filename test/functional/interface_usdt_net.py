...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/Itecoin/Itecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ItecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our Itecoind node")
