...
class RawTransactionsTest(ItecoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "Change address must be a valid Itecoin address", self.nodes[2].fundrawtransaction, rawtx, changeAddress='foobar')
    ...
    def test_option_feerate(self):
        ...
        # With no arguments passed, expect fee of 141 Igors.
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        # Igors more, than outputs 2 and 3.
    ...
    def test_feerate_rounding(self):
        ...
        # fail with insufficient funds rather than Itecoind asserting.
