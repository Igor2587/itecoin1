...
#ifndef Itecoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define Itecoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // Itecoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
