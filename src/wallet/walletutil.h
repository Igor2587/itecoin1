// Copyright (c) 2017-2021 The Itecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Itecoin_WALLET_WALLETUTIL_H
#define Itecoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! Itecoin from opening the wallet, thinking it was newly created, and
...
#endif // Itecoin_WALLET_WALLETUTIL_H
