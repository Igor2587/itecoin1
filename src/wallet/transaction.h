...
#ifndef Itecoin_WALLET_TRANSACTION_H
#define Itecoin_WALLET_TRANSACTION_H
...
public:
     ...
     * on this Itecoin node, and set to 0 for transactions that were created
...
#endif // Itecoin_WALLET_TRANSACTION_H
