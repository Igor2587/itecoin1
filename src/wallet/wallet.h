...
#ifndef Itecoin_WALLET_WALLET_H
#define Itecoin_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in Igors) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in Igors)
...
public:
    ...
    /** Absolute maximum transaction fee (in Igors) used by default for the wallet */
