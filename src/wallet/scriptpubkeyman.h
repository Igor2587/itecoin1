...
#ifndef Itecoin_WALLET_SCRIPTPUBKEYMAN_H
#define Itecoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Itecoin Core wallet was originally a collection of unrelated private
...
#endif // Itecoin_WALLET_SCRIPTPUBKEYMAN_H
