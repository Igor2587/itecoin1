...
#if defined(__linux__) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_Itecoin_INTERNAL)
#include <sys/auxv.h>
#include <asm/hwcap.h>
#endif

#if defined(MAC_OSX) && defined(ENABLE_ARM_SHANI) && !defined(BUILD_Itecoin_INTERNAL)
#include <sys/types.h>
...
std::string SHA256AutoDetect(sha256_implementation::UseImplementation use_implementation)
{
...
#if defined(ENABLE_X86_SHANI) && !defined(BUILD_Itecoin_INTERNAL)
    if (have_x86_shani) {
    ...
    if (have_sse4) {
        ...
        ret = "sse4(1way)";
#endif
#if defined(ENABLE_SSE41) && !defined(BUILD_Itecoin_INTERNAL)
        TransformD64_4way = sha256d64_sse41::Transform_4way;
        ret += ",sse41(4way)";
#endif
    }

#if defined(ENABLE_AVX2) && !defined(BUILD_Itecoin_INTERNAL)
...
#if defined(ENABLE_ARM_SHANI) && !defined(BUILD_Itecoin_INTERNAL)
