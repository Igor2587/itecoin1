...
#ifndef Itecoin_COMPAT_ASSUMPTIONS_H
#define Itecoin_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Itecoin cannot be compiled without assertions."
#endif
...
#endif // Itecoin_COMPAT_ASSUMPTIONS_H
