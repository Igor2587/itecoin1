...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.Itecoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.Itecoin.dashjr.org."); // Luke Dashjr
        vSeeds.emplace_back("seed.Itecoinstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.Itecoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.itc.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.Itecoin.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.Itecoin.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.Itecoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.titc.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.Itecoin.sprovoost.nl.");
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.Itecoin.sprovoost.nl.");
