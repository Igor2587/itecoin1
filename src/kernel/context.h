...
#ifndef Itecoin_KERNEL_CONTEXT_H
#define Itecoin_KERNEL_CONTEXT_H
...
//! passed to external libItecoin_kernel functions which need access to this
...
#endif // Itecoin_KERNEL_CONTEXT_H
