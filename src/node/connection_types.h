...
#ifndef Itecoin_NODE_CONNECTION_TYPES_H
#define Itecoin_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/Itecoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Itecoin’s Peer-to-Peer Network")
...
#endif // Itecoin_NODE_CONNECTION_TYPES_H
