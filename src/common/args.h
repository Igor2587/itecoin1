...
#ifndef Itecoin_COMMON_ARGS_H
#define Itecoin_COMMON_ARGS_H
...
extern const char * const Itecoin_CONF_FILENAME;
extern const char * const Itecoin_SETTINGS_FILENAME;
