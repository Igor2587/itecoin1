...
#ifndef Itecoin_PROTOCOL_H
#define Itecoin_PROTOCOL_H
...
/**
 * Itecoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Itecoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // Itecoin-development mailing list. Remember that service bits are just
