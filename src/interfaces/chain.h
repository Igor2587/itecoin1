...
#ifndef Itecoin_INTERFACES_CHAIN_H
#define Itecoin_INTERFACES_CHAIN_H
...
//! internal workings of the Itecoin node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/Itecoin/Itecoin/pull/15288#discussion_r253321096).
//!
...
//!   node (https://github.com/Itecoin/Itecoin/issues/11756)
class Chain
{
public:
    virtual ~Chain() {}
...
#endif // Itecoin_INTERFACES_CHAIN_H
