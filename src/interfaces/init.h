...
#ifndef Itecoin_INTERFACES_INIT_H
#define Itecoin_INTERFACES_INIT_H
...
//! (Itecoin-gui, Itecoin-node, Itecoin-wallet, Itecoind, Itecoin-qt) and each
...
#endif // Itecoin_INTERFACES_INIT_H
