...
#ifndef Itecoin_INTERFACES_NODE_H
#define Itecoin_INTERFACES_NODE_H
...
//! Top-level interface for a Itecoin node (Itecoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or Itecoin.conf.
...
#endif // Itecoin_INTERFACES_NODE_H
