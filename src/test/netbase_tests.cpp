...
{
    BOOST_CHECK(TestSplitHost("www.Itecoincore.org", "www.Itecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.Itecoincore.org]", "www.Itecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.Itecoincore.org:80", "www.Itecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.Itecoincore.org]:80", "www.Itecoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.Itecoincore.org:65536", "www.Itecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.Itecoincore.org:0", "www.Itecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.Itecoincore.org:", "www.Itecoincore.org:", 0, false));
}
