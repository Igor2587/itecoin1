...
#ifndef Itecoin_TEST_SCRIPTNUM10_H
#define Itecoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Itecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // Itecoin_TEST_SCRIPTNUM10_H
