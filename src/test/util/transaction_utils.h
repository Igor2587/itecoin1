// Copyright (c) 2019-2020 The Itecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef Itecoin_TEST_UTIL_TRANSACTION_UTILS_H
#define Itecoin_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // Itecoin_TEST_UTIL_TRANSACTION_UTILS_H
