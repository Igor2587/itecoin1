...
{
    // Test regression https://github.com/Itecoin/Itecoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/Itecoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/Itecoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Itecoin/Itecoin-Qt.conf and all else left as default,
    // Itecoin-qt should set both -listen and -listenonion to false and start successfully.
