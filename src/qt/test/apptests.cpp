...
//! Entry point for ItecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ItecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ItecoinGUI tests.
void AppTests::guiTests(ItecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ItecoinGUI::consoleShown, this, &AppTests::consoleTests);
