...
#ifndef Itecoin_QT_ItecoinGUI_H
#define Itecoin_QT_ItecoinGUI_H
...
/**
  Itecoin GUI main class. This class represents the main window of the Itecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ItecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ItecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~ItecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Itecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, ItecoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Itecoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(ItecoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // Itecoin_QT_ItecoinGUI_H
