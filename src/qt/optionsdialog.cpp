      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->ItecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ItecoinAtStartup);
    ...
    ui->ItecoinAtStartup->setToolTip(ui->ItecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ItecoinAtStartup->setText(ui->ItecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openItecoinConfButton->setToolTip(ui->openItecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ItecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ItecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openItecoinConfButton_clicked()
{
