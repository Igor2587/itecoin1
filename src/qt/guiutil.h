...
#ifndef Itecoin_QT_GUIUTIL_H
#define Itecoin_QT_GUIUTIL_H
...
/** Utility functions used by the Itecoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "Itecoin:" URI into recipient object, return true on successful parsing
