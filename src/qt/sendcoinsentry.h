...
#ifndef Itecoin_QT_SENDCOINSENTRY_H
#define Itecoin_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending Itecoins.
 */
...
#endif // Itecoin_QT_SENDCOINSENTRY_H
