...
#ifndef Itecoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define Itecoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // Itecoin_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
