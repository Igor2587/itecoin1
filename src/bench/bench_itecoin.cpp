...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  bench_Itecoin [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  bench_Itecoin executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * bench_Itecoin uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./bench_Itecoin -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./bench_Itecoin\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
